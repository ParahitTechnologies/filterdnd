                ...
                <tr> 
                    <td align="center">
                            <table width="98%" cellpadding="0" cellspacing="1" border="0" bgcolor="#ebebeb" style="margin-left:5px; margin-right:5px; margin-top:5px">
                                ...
                                <?php
                                $query = "select id,file_name,file_size,cdate,f_status from upload_file where agent='$user_id' and (f_status=1 || f_status=2) order by id desc";
                                $result = mysql_query($query);
                                ...
                                if (mysql_num_rows($result) > 0) {
                                    ...
                                    while ($rows = mysql_fetch_array($result)) {
                                        ...
                                        <tr bgcolor="white" height="21px">
                                            ...
                                            <td align="center" width="15%"><a style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px; text-decoration:none" href='download.php?p=<?= $ZIP_DIR; ?>&f=<?php echo $rows['dnc_f_name']; ?>'">Download</a>&nbsp;<a href="dnd_delete.php?act=<?php echo $rows[0]; ?>" onclick="return confirm('Sure to delete.???');"><img src="../images/delete.png" border="0"/></a></td>
                                        </tr>
                                        <?php
                                        $sn = $sn + 1;
                                    }
